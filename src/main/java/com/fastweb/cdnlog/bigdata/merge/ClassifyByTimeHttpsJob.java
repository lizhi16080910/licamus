 ...
 */
public class ClassifyByTimeHttpsJob extends Configured implements Tool {
    ...
    public static final String ETL_EXECUTION_CONF_PATH="etl.execution.conf.path";

    public static Properties props;

    public static void main(String[] args) throws Exception {
        ClassifyByTimeHttpsJob job = new ClassifyByTimeHttpsJob();
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setMapperClass(ExtraTimeHttpsMapper.class);
        job.setReducerClass(CdnlogReducer.class);

        String httpsConf = getConf().get(ETL_EXECUTION_CONF_PATH);

        job.addCacheFile(new URI(httpsConf + "#https.conf"));
