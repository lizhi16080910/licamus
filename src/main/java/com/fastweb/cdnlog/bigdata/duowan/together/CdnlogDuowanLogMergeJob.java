 ...
 */
public class CdnlogDuowanLogMergeJob extends Configured implements Tool {
    private static final Log LOG = LogFactory.getLog(CdnlogDuowanLogMergeJob.class);
    ...
    public static void main(String[] args) throws Exception {
        CdnlogDuowanLogMergeJob job = new CdnlogDuowanLogMergeJob();
